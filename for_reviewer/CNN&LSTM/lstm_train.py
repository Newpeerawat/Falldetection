...
def extract_subject_id(file_name):
    """
    Example filename: S06T20R01.csv
    Return subject ID: S06
    """
...
def create_sequences(data, window_size=50, overlap=0.5):
    ...
    - Overlap = 50%
    - Labeling strategy = last sample label in each window
    """
...
def subject_wise_split(X, y, subjects):
    """
    Subject-wise split:
    Subjects in train and test sets are completely separated.
    """
